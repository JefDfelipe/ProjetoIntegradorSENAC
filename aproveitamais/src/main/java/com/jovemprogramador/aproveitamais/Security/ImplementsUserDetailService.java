...
public class ImplementsUserDetailService implements UserDetailsService {
  ...
  public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
    ...
    // Objeto genérico com o usuário comparação if se verdadeiro senão se comparação
    // for falsa
    UserDetails userDetails = new User(login, (empresa != null) ? empresa.getPassword() : cliente.getPassword(),
        true, true, true, true, (empresa != null) ? empresa.getAuthorities() : cliente.getAuthorities());
